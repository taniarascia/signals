...
},{"./flashcardController.js":2,"./flashcardModel.js":3,"./flashcardView.js":4}],2:[function(require,module,exports){
'use strict';
...
},{"./flashcardModel.js":3,"./up.js":5}],3:[function(require,module,exports){
"use strict";
...
var FlashcardModel = function () {
  ...
  _createClass(FlashcardModel, [{
    ...
    value: function generateRandomNum() {
      var number = Math.floor(Math.random() * _up.flashcardContent.length);
    ...
    value: function attachContentToDOM(action) {
      var setQandA = function setQandA(index) {
        ...
        var card = _up.flashcardContent[index];
...
},{"./up.js":5}],4:[function(require,module,exports){
'use strict';
...
},{"./flashcardController.js":2,"./flashcardModel.js":3}],5:[function(require,module,exports){
"use strict";
