...
var flashcardContent = exports.flashcardContent = [{
  ...
  "name": "divering clear approach diverging",
  "top": "red",
  ...
  "name": "diverging approach resticting",
  "top": "red flashing",
  "middle": "yellow",
  "bottom": "none",
  "plate": false
...
},{"./cn.js":2,"./flashcardModel.js":4}],4:[function(require,module,exports){
"use strict";
...
var FlashcardModel = function () {
  ...
  _createClass(FlashcardModel, [{
    ...
    value: function generateRandomNum() {
      var number = Math.floor(Math.random() * _cn.flashcardContent.length);
    ...
    value: function attachContentToDOM(action) {
      var setQandA = function setQandA(index) {
        ...
        var card = _cn.flashcardContent[index];
...
},{"./cn.js":2}],5:[function(require,module,exports){
'use strict';
